...
export const JobCard = memo(function JobCard({ job, onStatusChange: _onStatusChange, onViewDetails, onDelete, selectable = false, isSelected = false, onToggleSelect }: JobCardProps) {
