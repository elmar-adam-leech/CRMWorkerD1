...
- **Mobile UX**: Fixed bottom nav bar (`MobileBottomNav.tsx`) on ≤767px screens with Dashboard/Leads/Estimates/Messages/More; mobile-first page padding; responsive PageHeader stacking; mobile quick actions on Job and Estimate cards.
